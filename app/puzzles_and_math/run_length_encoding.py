"""
Simple version of problem: Compress a string with basic encoding.
eg - "AAAAA" return "5A"
"BAAAB" returns "B3AB"
"ABAB" returns "ABAB" (not interested in characters repeating in groups)

Assume a given char doesnt repeat more than 127 times.

Important twists to the problem -
1) String can include numbers
2) Compressed length must not be greater than original length.
"""
