"""
This is a string puzzle disguised as a programing problem. Its also called SnakeString.

THe phrase "Google Worked" should be printed as follows (where ~ is the word separator)
    o     ~       k
  o  g  e   W   r   e
G     l       o       d
"""
