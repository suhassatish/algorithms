...
def shortest_path(start, end):
    ...
    Keep track of who enqueue what in back_refs dictionary.

    Dijkstra works with cycles and works for directed graphs.
    It doesn't work only for negative-weighted edges
    :param start:
    :param end:
    :return:

    back_refs = {start: None}
    q = Queue()
    q.put(start)
    while not q.empty():
        v = q.get()
    ...
    if end not in back_refs:
        return None
    pass
    # TODO: there's more here, refer video lecture
